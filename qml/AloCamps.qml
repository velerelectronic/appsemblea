...
Core.FeedView {
    ...
    titol: qsTr('Alo Camps')
    homePage: 'http://aloconsellera1.wordpress.com/'
    ...
    Core.CachedModel {
        ...
        source: 'https://script.google.com/macros/s/AKfycbw6qq6UasD3eZckBwfIf-sOCDpR93qdb35CYZhFc7f7PQMX9WlY/exec?opt=alo1'
        categoria: 'aloCamps'
        typeFiltra: true
    }
